...
```{r}
library(readr)
jugadoresNBA_2023 <- read_delim("jugadoresNBA2023.csv", 
...
equipos2023 <- read_delim("equipos2023.csv", 
...
jugadoresNBA_2022 <- read_delim("jugadoresNBA2022.csv", 
    delim = ";", escape_double = FALSE, col_types = cols(AGE = col_number(), 
        GP = col_number(), W = col_number(), 
        L = col_number(), MIN = col_number(), 
        PTS = col_number(), FGM = col_number(), 
...
equipos2022 <- read_delim("equipos2022.csv", 
    delim = ";", escape_double = FALSE, col_types = cols(GP = col_integer(), 
        W = col_integer(), L = col_integer(), 
        `WIN%` = col_number(), MIN = col_number(), 
        PTS = col_number(), FGM = col_number(), 
...
```{r}
library(tidyr)
max_puntos <- bind_rows(jugadoresNBA_2022,jugadoresNBA_2023)
max_puntos <- max_puntos %>% select(PLAYER,PPG,SEASON) %>%
